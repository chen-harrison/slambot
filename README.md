...
The resulting map is shown above, since duration of the run exceeded 20 minutes and was not practical to show. The lack of seamlessness in the movement patterns diminishes map quality, but the result is still a coherent representation of the maze environment.
